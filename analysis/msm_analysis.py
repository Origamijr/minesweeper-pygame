...
def find_num_solutions(MSMs, min_n=None, max_n=None, seed=None, dbg=False):
    ...
    num_with_mine = find_num_solutions(MSMs_mine, min_n=min_n, max_n=max_n, seed=seed, dbg=dbg)
    ...
    num_wo_mine = find_num_solutions(MSMs_clear, min_n=min_n, max_n=max_n, seed=seed, dbg=dbg)
